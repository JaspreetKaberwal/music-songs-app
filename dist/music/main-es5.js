(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApiCallsService = /** @class */ (function () {
                ...
                ApiCallsService.prototype.signUp = function (username, password) {
                    return this.http.post(this.BASE_URL + "/signup", { username: username, password: password });
                };
                ApiCallsService.prototype.login = function (username, password) {
                    return this.http.post(this.BASE_URL + "/login", { username: username, password: password });
                };
                ApiCallsService.prototype.addSong = function (song) {
                    return this.http.post(this.BASE_URL + "/song", song);
                };
                ApiCallsService.prototype.getSongs = function () {
                    return this.http.get(this.BASE_URL + "/songs");
                };
                ApiCallsService.prototype.deleteSong = function (songId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.newSong = function () {
                    var _this = this;
                    this.api.addSong(this.song).subscribe(function (resp) {
                        if (resp.success) {
                            _this.getSongs();
                        }
                    });
                };
                HomeComponent.prototype.updatePage = function (songs) {
                    var _this = this;
                    this.showModal = false;
                    this.allSongs = songs;
                    this.allPlaylists = this.genres.map(function (genre) {
                        return {
                            genre: genre,
                            songs: _this.allSongs.filter(function (song) { return song.genre == genre; })
                        };
                    });
                };
                HomeComponent.prototype.getSongs = function () {
                    var _this = this;
                    this.api.getSongs().subscribe(function (resp) {
                        if (resp.success) {
                            _this.updatePage(resp.songs);
                        }
                    });
                };
                HomeComponent.prototype.deleteSong = function (songId) {
                    var _this = this;
                    this.api.deleteSong(songId).subscribe(function (resp) {
                        if (resp.success) {
                            _this.getSongs();
                        }
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.login = function () {
                    var _this = this;
                    this.api.login(this.username, this.password).subscribe(function (resp) {
                        if (resp.success) {
                ...
                LoginComponent.prototype.signUp = function () {
                    var _this = this;
                    this.api.signUp(this.username, this.password).subscribe(function (resp) {
                        if (resp.success) {
